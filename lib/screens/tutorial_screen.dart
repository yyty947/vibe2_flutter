                  ...
                  children: [
                    _Section(
                      ...
                      body:
                          ...
                          'INTERVIEW（面试度）— 为跳槽做的准备。达到 80 且怀疑度低于 85 可触发金蝉脱壳结局。\n'
                    ...
                    _Section(
                      ...
                      title: '行动选择（12选4动态池）',
                      body:
                          '每次 Morning 和 Afternoon 行动阶段，从 12 种行动中随机抽取 4 种供你选择。\n\n'
                          '写业务代码 — 稳定产出，降低怀疑\n'
                          '修屎山Bug — 大幅提升KPI，消耗精力\n'
                          '偷偷刷八股文 — 提升面试度，增加怀疑\n'
                          '带薪拉屎 — 恢复精力\n'
                    ...
                    _Section(
                      ...
                      body:
                          '根据你的属性值，会自动激活增益（Buff）或减益（Debuff）状态：\n\n'
                    ...
                    _Section(
                      ...
                      title: '技能树（4分支 × 3层）',
                      body:
                          'Day 7 / 14 / 21 结算时获得成长点（点数 = 基础值 + KPI ÷ 系数）。\n\n'
                          '四个分支：\n'
                          '精力管理（绿色）— 降低精力消耗\n'
                          '代码效率（青色）— 提升KPI收益\n'
                          '社交技巧（琥珀）— 降低怀疑度增长\n'
                    ...
                    _Section(
                      ...
                      title: '五种结局',
                      body:
                          'BE_DEATH — 精力归零，ICU抢救无效\n'
                          'BE_FIRED — 绩效垫底，被保安请出大楼\n'
                          'GE_OFFER — 面试度达标且怀疑度未过高，跳槽成功\n'
                    ...
                    _Section(
                      ...
                      title: '玩家小贴士',
                      body:
                          '· 前期（Day 1-10）优先降低怀疑度，获取 TRUSTED buff\n'
